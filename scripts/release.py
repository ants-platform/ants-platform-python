...
def update_version_file(version):
    version_file_path = "ants_platform/version.py"
...
def main():
    parser = argparse.ArgumentParser(
        description="Automate the release process for the Ants Platform Python SDK using Poetry."
    )
    parser.add_argument(
        "increment_type",
    ...
    try:
        ...
        # Update the version in ants_platform/version.py
        ...
        print(
            "Go to: https://github.com/ants-platform/ants-python/releases to create the release."
        )

...
class LangfuseAPI:
    def __init__(self, username=None, password=None, base_url=None):
        username = username if username else os.environ["ANTS_PLATFORM_PUBLIC_KEY"]
        password = password if password else os.environ["ANTS_PLATFORM_SECRET_KEY"]
        self.auth = (username, password)
        self.BASE_URL = base_url if base_url else os.environ["ANTS_PLATFORM_HOST"]

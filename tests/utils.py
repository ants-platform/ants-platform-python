...
from ants_platform.api.client import FernLangfuse
...
def get_api():
    ...
    return FernLangfuse(
        username=os.environ.get("ANTS_PLATFORM_PUBLIC_KEY"),
        password=os.environ.get("ANTS_PLATFORM_SECRET_KEY"),
        base_url=os.environ.get("ANTS_PLATFORM_HOST"),
    )
